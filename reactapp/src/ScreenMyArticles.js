...
function ScreenMyArticles(props) {
  ...
  var listMyArticles = props.article.map((news, i)=>{
    return(
    <div className="Card" style={{display:'flex', direction: 'row'}}>
                      ...
                      <Card
                        ...
                        actions={[
                          <Icon type="read" key="ellipsis2" />,
                            <Icon type="delete" key="ellipsis" onClick={()=>props.deleteToWishList({img: news.img, desc:news.desc, title: news.title})}/>
                        ]}
                        >
...
//on récupére dpuis le store le state.article et le state.token
